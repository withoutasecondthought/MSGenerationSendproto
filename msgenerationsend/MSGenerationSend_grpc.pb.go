...
type PersonClient interface {
	SendPerson(ctx context.Context, in *PersonRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *personClient) SendPerson(ctx context.Context, in *PersonRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/msgenerationsend.Person/SendPerson", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PersonServer interface {
	SendPerson(context.Context, *PersonRequest) (*emptypb.Empty, error)
...
func (UnimplementedPersonServer) SendPerson(context.Context, *PersonRequest) (*emptypb.Empty, error) {
...
func _Person_SendPerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PersonRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServer).SendPerson(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/msgenerationsend.Person/SendPerson",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServer).SendPerson(ctx, req.(*PersonRequest))
	}
...
var Person_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "msgenerationsend.Person",
	HandlerType: (*PersonServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendPerson",
			Handler:    _Person_SendPerson_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/MSGenerationSend.proto",
}
